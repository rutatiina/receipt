...
class CreateRgReceiptSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_receipt_settings', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_receipt_settings');
    }
}
