        ...
        <div class="page-header page-header-light d-print-none">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-files-empty2 mr-2"></i> <span class="font-weight-semibold">Receipt</span></h4>
                    ...
                    <div class="card-header header-elements-inline d-print-none text-danger">
                        ...
                        <div class="header-elements">
                            <button type="button"
                                    ...
                                    @click="txnApprove('/receipts/'+txnData.id+'/approve')"><i class="icon-printer mr-2"></i> Click here to Approve</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card max-width-960 m-auto rg-print-border-0" v-if="!this.$root.loadingTxn">
                    ...
                    <div class="card-header bg-transparent header-elements-inline d-print-none">
                        ...
                        <div class="header-elements">
                            ...
                            <router-link :to="'/receipts/'+$route.params.id+'/edit'"
...
<script>
    ...
    export default {
        name: 'AccountingSalesReceiptsShow',
        //components: {},
        data() {
            return {}
        },
