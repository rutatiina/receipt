                    ...
                    <form v-if="!this.$root.loading"
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5">
                                    <div class="input-group">
                                        ...
                                        <input type="text" v-model="txnAttributes.total" class="form-control font-weight-semibold text-right" placeholder="Amount received">
                                    </div>
                                </div>
                                <div class="col-lg-5 col-form-label">
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" v-model="receiptAutoSetItemsTotalCheckbox" class="custom-control-input" id="txn-auto-pay" >
                                        <label class="custom-control-label" for="txn-auto-pay">Auto pay invoice(s)</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="col pl-0">
                                        <model-list-select :list="receiptDebitAccounts"
                                                           v-model="txnAttributes.debit_financial_account_code"
                                                           option-value="code"
                                                           option-text="name"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5">
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" v-model="receiptOnInvoices" class="custom-control-input" id="txn-is-recurring" >
                                        <label class="custom-control-label" for="txn-is-recurring">Make receipt for Invoice(s) issued.</label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <th width="" class="h6">
                                        ...
                                        <small class="pull-right pt-5">
                                            <a href="/" v-on:click.prevent="receiptAllItemsPaidInFull">(Pay all fully)</a>
                                        </small>
                                    </th>
                                    ...
                                    <th width="" class="h6 text-left">
                                        Receipt amount
                                        <small class="pull-right pt-5">
                                            <a href="/" v-on:click.prevent="receiptAllItemsRateReset">(Clear amounts)</a>
                                        </small>
                                    </th>
                                </tr>
                                </thead>
                                    ...
                                    <tr v-for="(item, index) in txnAttributes.items"
                                        ...
                                        <td class="">
                                            ...
                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                ...
                                                <label class="custom-control-label" v-model="item.paidInFull" :for="'contact-invoice-'+item.invoice.id">Paid in full</label>
                                            </div>
                                        </td>
                                        <td class="text-right">
                                            <span class="text-primary font-weight-semibold">{{rgNumberFormat(item.invoice.total, 2)}}</span>
                                            <small>{{item.invoice.base_currency}}</small>
                                        </td>
                                        <td class="text-right h6">
                                            <span class="text-danger font-weight-semibold">{{rgNumberFormat(item.invoice.balance, 2)}}</span>
                                            <small>{{item.invoice.base_currency}}</small>
                                        </td>
                                        <td class="text-right align-middle">
                                            <div class="input-group">
                                                <span class="input-group-prepend">
                                                    <span class="input-group-text">{{item.invoice.base_currency}}</span>
                                                </span>
                                                <input type="text"
                                                       v-model="item.rate"
        ...
        computed: {
            receiptTotalDue: function () {
                ...
                currentObj.txnAttributes.items.forEach(function (item) {
                    ...
                    if (typeof item.invoice !== 'undefined' && typeof item.invoice.balance !== 'undefined') {
